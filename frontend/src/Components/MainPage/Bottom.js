		...
		<div className="bottom">
			...
			<div className="bottom__icons">
				<a
					...
					rel="noreferrer"
				>
					<img src={facebookLogo} alt="fb_icon" width="30px"></img>
				</a>
				<a href="/" target="_blank" rel="noopener">
					<img src={linkedin} alt="linkedin_icon" width="30px"></img>
				</a>
				<a
					...
					rel="noreferrer"
				>
					<img src={instagram} alt="insta_icon" width="30px"></img>
				</a>
				<a
					...
					rel="noreferrer"
				>
					<img src={twitter} alt="twitter_icon" width="30px"></img>
				</a>
			</div>
