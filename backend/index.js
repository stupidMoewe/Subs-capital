                        ...
                        rss: [
                            ...
                            },
                            {
                                channel: __spreadArray([
                                    ...
                                    {
                                        description: "Une solution d'épargne alternative et innovante dans les cryptos-actifs."
                                    },
                                    { language: "fr-FR" }
...
function buildFeed(posts) {
    ...
    feedItems.push.apply(feedItems, sortedPosts.map(function (post) {
        ...
        $("a[href^='/'], img[src^='/']").each(function () {
            var $this = $(this);
            if ($this.attr("href")) {
                $this.attr("href", "www.subs-capital.fr/" + $this.attr("href"));
            }
            if ($this.attr("src")) {
                $this.attr("src", "www.subs-capital.fr/" + $this.attr("src"));
            }
        });
